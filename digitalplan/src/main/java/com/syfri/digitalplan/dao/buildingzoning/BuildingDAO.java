...
public interface BuildingDAO extends BaseDAO<BuildingVO>{
    ...
    //通过装置id 获取装置中所有组成信息
    public List<ZuchengVO> doFindZuChengList(ZuchengVO vo);
    //通过装置id 获取装置中所有产物信息
    public List<YuanliaoVO> doFindYuanLiaoList(YuanliaoVO vo);
    //通过装置id 获取装置中所有原料信息
    public List<ChanwuVO> doFindChanWuList(ChanwuVO vo);
    //通过罐组id 获取罐组中所有储罐信息
