...
public class Firefacilities_xfkzsVO extends FirefacilitiesVO implements Serializable{
	...
	public String getIszdbj(){
		return iszdbj;
	}
	public void setIszdbj(String iszdbj){
		this.iszdbj = iszdbj;
	}
	public String getIsldkz(){
		return isldkz;
	}
