...
public class YuanliaoVO extends ValueObject implements Serializable{
	...
	private String ylmc;	//原料名称
	private String lhxz;	//理化性质
	private String ylcl;	//原料储量
	...
	public String getYlcl(){
		return ylcl;
	}
	public void setYlcl(String ylcl){
		this.ylcl = ylcl;
	}
