...
public class ZongdVO extends ValueObject implements Serializable{
	...
	private String wzgys;	//文职雇员数
	private String xxzhids;	//下辖支队数
	private String xxzhongds;	//下辖中队数
	private String zdzxm;	//总队长姓名
	private String zdzlxfs;	//总队长联系方式
	private String zdzwxm;	//总队政委姓名
	private String zdzwlxfs;	//总队政委联系方式
	...
	public String getWzgys() {
		return wzgys;
	}
	public void setWzgys(String wzgys) {
		this.wzgys = wzgys;
	}
	public String getXxzhids() {
		return xxzhids;
	}
	public void setXxzhids(String xxzhids) {
		this.xxzhids = xxzhids;
	}
