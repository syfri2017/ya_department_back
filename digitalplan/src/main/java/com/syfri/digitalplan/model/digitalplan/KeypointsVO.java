...
public class KeypointsVO extends ValueObject implements Serializable{
	...
	public void setZsyd(String zsyd){
		this.zsyd = zsyd;
	}
	public String getTbjs(){
		return tbjs;
	}
	public void setTbjs(String tbjs){
		this.tbjs = tbjs;
	}
