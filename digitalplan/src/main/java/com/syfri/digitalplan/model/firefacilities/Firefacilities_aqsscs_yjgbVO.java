...
public class Firefacilities_aqsscs_yjgbVO extends FirefacilitiesVO implements Serializable{

	private static final long serialVersionUID = 1L;

	private String uuid;	//主键
	private String xfssid;	//消防设施ID
	private String jzid;	//所属建（构）筑
	private String wz;	//位置
	private String isyjgb;	//应急广播有无[0]无，[1]有
	...
	public String getIsyjgb(){
		return isyjgb;
	}
	public void setIsyjgb(String isyjgb){
		this.isyjgb = isyjgb;
	}
