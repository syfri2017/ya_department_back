...
public class Firefacilities_zqmhxt_bgdsVO extends FirefacilitiesVO implements Serializable{
	...
	public String getEdyl(){
		return edyl;
	}
	public void setEdyl(String edyl){
		this.edyl = edyl;
	}
