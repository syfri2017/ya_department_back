        ...
        <div id="cover" class="content-block cover-block block-level-1" data-menu-text="封面">
            <div class="cover-body">
                ...
                <ul class="cover-info-list">
                    ...
                    <#--<li><strong>预案状态：</strong><#if compPlanInfo.yaztmc??>${compPlanInfo.yaztmc}</#if></li>-->
                    <li><strong>预案级别：</strong><#if compPlanInfo.yajbmc??>${compPlanInfo.yajbmc}</#if></li>
                    <#--<li><strong>是否跨区域：</strong><#if compPlanInfo.fhdzmc??>${compPlanInfo.fhdzmc}</#if></li>-->
                ...
                <#--<div class="update-row">-->
                    ...
                    <#--</span>-->
                    <#--<span class="uodate-date-field">-->
                        <#--<strong>预案审核/更新时间：</strong><#if compPlanInfo.shsj??>${compPlanInfo.shsj}</#if>-->
                    <#--</span>-->
                    <#--<span class="uodate-duty-field">-->
                        <#--<strong>审核人职务：</strong><#if compPlanInfo.shztmc??>${compPlanInfo.shztmc}</#if>-->
                    <#--</span>-->
                    <#--<span class="uodate-name-field">-->
